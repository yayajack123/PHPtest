...
<head>
<title>Penyebaran COVID-19 di Denpasar Selatan</title>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<!--        <meta http-equiv="X-UA-Compatible" content="IE=8" />-->
<meta name="description" content="Penyebaran COVID-19 di Denpasar Selatan" />
<script type="text/javascript" src="./js-2.5.2/version.js.php"></script>
<link rel="shortcut icon" href="./favicon.ico" />
<link rel="alternate" type="application/rss+xml" title="Penyebaran COVID-19 di Denpasar Selatan GeoRSS Feed" href="georss.xml" />
<style type="text/css">
html, body {
margin: 0;
padding: 0;
...
border-width:1px;
border-style:solid;
border-color:#aaa #0B1A03 #0B1A03 #aaa;
background-color: #DEDBCF;
color: #4F4F4F;
}
.inputtext{
...
/* info_window max / min height */
.info_window.disp_iw_desc.no_disp_iw_add.no_disp_iw_coord.no_disp_iw_url.no_disp_iw_email .info_window_description {
/* desc */
max-height: 225px;
}
.info_window.disp_iw_desc.disp_iw_add.no_disp_iw_coord.no_disp_iw_url.no_disp_iw_email .info_window_description {
/* desc + add */
max-height: 200px;
}
.info_window.disp_iw_desc.disp_iw_add.disp_iw_coord.no_disp_iw_url.no_disp_iw_email .info_window_description {
/* desc + add + geocode*/
max-height: 165px;
}
.info_window.disp_iw_desc.no_disp_iw_add.disp_iw_coord.no_disp_iw_url.no_disp_iw_email .info_window_description,
.info_window.disp_iw_desc.disp_iw_add.disp_iw_coord.disp_iw_url.no_disp_iw_email .info_window_description,
.info_window.disp_iw_desc.disp_iw_add.disp_iw_coord.no_disp_iw_url.disp_iw_email .info_window_description {
/* desc + geocode */
/* desc + add + geocode + url / email*/
max-height: 165px;
}
.info_window.disp_iw_desc.disp_iw_add.disp_iw_coord.disp_iw_url.disp_iw_email .info_window_description {
/* desc + add + geocode + url + email*/
max-height: 150px;
}
.info_window.disp_iw_desc.no_disp_iw_add.no_disp_iw_coord.disp_iw_url.no_disp_iw_email .info_window_description,
.info_window.disp_iw_desc.no_disp_iw_add.no_disp_iw_coord.no_disp_iw_url.disp_iw_email .info_window_description {
/* desc + url / email */
max-height: 200px;
}
.info_window.disp_iw_desc.no_disp_iw_add.disp_iw_url.disp_iw_email .info_window_description {
/* desc + url + email */
max-height: 200px;
}
.info_window.disp_iw_desc.disp_iw_add.no_disp_iw_coord.disp_iw_url.disp_iw_email .info_window_description {
/* desc + add + url + email */
max-height: 175px;
}
/* Gestion en height pour IE */
.info_window.browser_is_ie .info_window_description {
height: 150px;
}
.info_window.browser_is_ie .info_window_text_text, .info_window.browser_is_ie .info_window_code {
height: 225px;
}
.info_window.browser_is_ie .info_window_photo_legend {
height: 75px;
}
.info_window.browser_is_ie.disp_iw_desc.no_disp_iw_add.no_disp_iw_coord.no_disp_iw_url.no_disp_iw_email .info_window_description {
/* desc */
height: 225px;
}
.info_window.browser_is_ie.disp_iw_desc.disp_iw_add.no_disp_iw_coord.no_disp_iw_url.no_disp_iw_email .info_window_description {
/* desc + add */
height: 200px;
}
.info_window.browser_is_ie.disp_iw_desc.disp_iw_add.disp_iw_coord.no_disp_iw_url.no_disp_iw_email .info_window_description {
/* desc + add + geocode*/
height: 165px;
}
.info_window.browser_is_ie.disp_iw_desc.no_disp_iw_add.disp_iw_coord.no_disp_iw_url.no_disp_iw_email .info_window_description,
.info_window.browser_is_ie.disp_iw_desc.disp_iw_add.disp_iw_coord.disp_iw_url.no_disp_iw_email .info_window_description,
.info_window.browser_is_ie.disp_iw_desc.disp_iw_add.disp_iw_coord.no_disp_iw_url.disp_iw_email .info_window_description {
/* desc + geocode */
/* desc + add + geocode + url / email*/
height: 165px;
}
.info_window.browser_is_ie.disp_iw_desc.disp_iw_add.disp_iw_coord.disp_iw_url.disp_iw_email .info_window_description {
/* desc + add + geocode + url + email*/
height: 150px;
}
.info_window.browser_is_ie.disp_iw_desc.no_disp_iw_add.no_disp_iw_coord.disp_iw_url.no_disp_iw_email .info_window_description,
.info_window.browser_is_ie.disp_iw_desc.no_disp_iw_add.no_disp_iw_coord.no_disp_iw_url.disp_iw_email .info_window_description {
/* desc + url / email */
height: 200px;
}
.info_window.browser_is_ie.disp_iw_desc.no_disp_iw_add.disp_iw_url.disp_iw_email .info_window_description {
/* desc + url + email */
height: 200px;
}
.info_window.browser_is_ie.disp_iw_desc.disp_iw_add.no_disp_iw_coord.disp_iw_url.disp_iw_email .info_window_description {
/* desc + add + url + email */
height: 175px;
}
/* Drawings style */
...
/* no-repeat left, top */
/* 1st line */
.poly_linecolor_FF8080 {
background: url(./drawing-icons.png) no-repeat 0px 0px;
}
.poly_linecolor_FFFF80 {
background: url(./drawing-icons.png) no-repeat -17px 0px;
}
.poly_linecolor_80FF80 {
background: url(./drawing-icons.png) no-repeat -33px 0px;
}
.poly_linecolor_009B80 {
background: url(./drawing-icons.png) no-repeat -49px 0px;
}
.poly_linecolor_80FFFF {
background: url(./drawing-icons.png) no-repeat -65px 0px;
}
.poly_linecolor_0080FF {
background: url(./drawing-icons.png) no-repeat -81px 0px;
}
.poly_linecolor_FF80C0 {
background: url(./drawing-icons.png) no-repeat -97px 0px;
}
.poly_linecolor_FF80FF {
background: url(./drawing-icons.png) no-repeat -113px 0px;
}
/* 2nd line */
.poly_linecolor_FF0000 {
background: url(./drawing-icons.png) no-repeat 0px -17px;
}
.poly_linecolor_FFFF00 {
background: url(./drawing-icons.png) no-repeat -17px -17px;
}
.poly_linecolor_80FF00 {
background: url(./drawing-icons.png) no-repeat -33px -17px;
}
.poly_linecolor_00FF40 {
background: url(./drawing-icons.png) no-repeat -49px -17px;
}
.poly_linecolor_00FFFF {
background: url(./drawing-icons.png) no-repeat -65px -17px;
}
.poly_linecolor_0080C0 {
background: url(./drawing-icons.png) no-repeat -81px -17px;
}
.poly_linecolor_8080C0 {
background: url(./drawing-icons.png) no-repeat -97px -17px;
}
.poly_linecolor_FF00FF {
background: url(./drawing-icons.png) no-repeat -113px -17px;
}
/* 3rd line */
.poly_linecolor_804040 {
background: url(./drawing-icons.png) no-repeat 0px -33px;
}
.poly_linecolor_FF8040 {
background: url(./drawing-icons.png) no-repeat -17px -33px;
}
.poly_linecolor_00FF00 {
background: url(./drawing-icons.png) no-repeat -33px -33px;
}
.poly_linecolor_008080 {
background: url(./drawing-icons.png) no-repeat -49px -33px;
}
.poly_linecolor_004080 {
background: url(./drawing-icons.png) no-repeat -65px -33px;
}
.poly_linecolor_8080FF {
background: url(./drawing-icons.png) no-repeat -81px -33px;
}
.poly_linecolor_800040 {
background: url(./drawing-icons.png) no-repeat -97px -33px;
}
.poly_linecolor_FF0080 {
background: url(./drawing-icons.png) no-repeat -113px -33px;
}
/* 4th line */
.poly_linecolor_800000 {
background: url(./drawing-icons.png) no-repeat 0px -49px;
}
.poly_linecolor_FF8000 {
background: url(./drawing-icons.png) no-repeat -17px -49px;
}
.poly_linecolor_008000 {
background: url(./drawing-icons.png) no-repeat -33px -49px;
}
.poly_linecolor_008040 {
background: url(./drawing-icons.png) no-repeat -49px -49px;
}
.poly_linecolor_0000FF {
background: url(./drawing-icons.png) no-repeat -65px -49px;
}
.poly_linecolor_00A0A0 {
background: url(./drawing-icons.png) no-repeat -81px -49px;
}
.poly_linecolor_800080 {
background: url(./drawing-icons.png) no-repeat -97px -49px;
}
.poly_linecolor_8000FF {
background: url(./drawing-icons.png) no-repeat -113px -49px;
}
/* 5th line */
.poly_linecolor_400000 {
background: url(./drawing-icons.png) no-repeat 0px -65px;
}
.poly_linecolor_804000 {
background: url(./drawing-icons.png) no-repeat -17px -65px;
}
.poly_linecolor_004000 {
background: url(./drawing-icons.png) no-repeat -33px -65px;
}
.poly_linecolor_004040 {
background: url(./drawing-icons.png) no-repeat -49px -65px;
}
.poly_linecolor_000080 {
background: url(./drawing-icons.png) no-repeat -65px -65px;
}
.poly_linecolor_000040 {
background: url(./drawing-icons.png) no-repeat -81px -65px;
}
.poly_linecolor_400040 {
background: url(./drawing-icons.png) no-repeat -97px -65px;
}
.poly_linecolor_400080 {
background: url(./drawing-icons.png) no-repeat -113px -65px;
}
/* 6th line */
.poly_linecolor_000000 {
background: url(./drawing-icons.png) no-repeat 0px -81px;
}
.poly_linecolor_808000 {
background: url(./drawing-icons.png) no-repeat -17px -81px;
}
.poly_linecolor_808040 {
background: url(./drawing-icons.png) no-repeat -33px -81px;
}
.poly_linecolor_808080 {
background: url(./drawing-icons.png) no-repeat -49px -81px;
}
.poly_linecolor_408080 {
background: url(./drawing-icons.png) no-repeat -65px -81px;
}
.poly_linecolor_C0C0C0 {
background: url(./drawing-icons.png) no-repeat -81px -81px;
}
.poly_linecolor_200020 {
background: url(./drawing-icons.png) no-repeat -97px -81px;
}
.poly_linecolor_FFFFFF {
background: url(./drawing-icons.png) no-repeat -113px -81px;
}        </style>
<script type="text/javascript" src="https://www.google.com/jsapi?key=AIzaSyASbU5QzkpcIIKXQya-JQon1ocexSqU6tc"></script>
<script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyASbU5QzkpcIIKXQya-JQon1ocexSqU6tc&v=3.19&sensor=false&libraries=geometry,drawing,places"></script>
<script type="text/javascript">

google.maps.visualRefresh=false;var geocoder=new google.maps.Geocoder();var G_NORMAL_MAP=google.maps.MapTypeId.ROADMAP;var G_SATELLITE_MAP=google.maps.MapTypeId.SATELLITE;var G_HYBRID_MAP=google.maps.MapTypeId.HYBRID;var G_PHYSICAL_MAP=google.maps.MapTypeId.TERRAIN;var G_SATELLITE_3D_MAP=google.maps.MapTypeId.G_SATELLITE_MAP;function GMap2(elem){google.maps.visualRefresh=false;var self=this;this._overlays=[];this.fireOnNextIdle=[];this._zoom=this._oldZoom=13;this._center=new google.maps.LatLng(0,0);this._bounds=this._oldBounds=null;var styles=[{"featureType":"poi","stylers":[{"visibility":"off"}]}];if(_saturation){styles.push({"stylers":[{"saturation":_saturation}]});}
...
GMarker._INFOWINDOW_PADDING=10;GMarker._INFOWINDOW_MIN_WIDTH=380;GMarker.infoWindowStyle={shadowStyle:0,padding:GMarker._INFOWINDOW_PADDING,tabPadding:12,backgroundColor:'#fff',borderRadius:3,arrowSize:15,borderWidth:1,borderColor:'#ccc',disableAutoPan:false,hideCloseButton:false,arrowPosition:50,arrowStyle:0};GMarker.prototype.openInfoWindowHtml=function(html){if(GMarker.lastInfoWindow){GMarker.lastInfoWindow.close();GMarker.lastInfoWindow=null;}
...
<div id="header" >
<div id="header-content"><h1 id="title">Penyebaran COVID-19 di Denpasar Selatan</h1></div>
</div>
<div id="mapDescription" >
<div id="mapDescription-content"><span class="description">Penyebaran COVID-19 di Denpasar Selatan</span></div>
</div>
<div id="main">
<div id="main-content">
<div id="map">
...
<div id="sidebar" >
<div id="sidebar-content" style="margin-right:8px;">
<div id="tab-content" style="border-top:1px solid #aaa;">
<div id="markers_tab_content" class="current_tab" style="margin-top:3px;">
<table class="markerlist"><tr class="markerrow"><td class="markericoncell" valign="top"><a href="javascript:void(C2MEngine.instance.openDrawing(1259055));" title=""><img src="./grd_polygon.png" style="border:0;width:16px;height:16px;" class="png" alt="" /></a></td><td class="markertitlecell"><input id="chkdrawing1259055" type="checkbox" onclick="C2MEngine.instance.chgDrawingDisp(1259055)" checked="true" />&nbsp;<a id="linkdrawing1259055" href="javascript:void(C2MEngine.instance.openDrawing(1259055));" title="" class="link_markername">Kelurahan/Desa Serangan</a></td></tr><tr class="markerrow"><td class="markericoncell" valign="top"><a href="javascript:void(C2MEngine.instance.openDrawing(1259058));" title=""><img src="./grd_polygon.png" style="border:0;width:16px;height:16px;" class="png" alt="" /></a></td><td class="markertitlecell"><input id="chkdrawing1259058" type="checkbox" onclick="C2MEngine.instance.chgDrawingDisp(1259058)" checked="true" />&nbsp;<a id="linkdrawing1259058" href="javascript:void(C2MEngine.instance.openDrawing(1259058));" title="" class="link_markername">Kelurahan/Desa Sanur Kaja</a></td></tr><tr class="markerrow"><td class="markericoncell" valign="top"><a href="javascript:void(C2MEngine.instance.openDrawing(1259061));" title=""><img src="./grd_polygon.png" style="border:0;width:16px;height:16px;" class="png" alt="" /></a></td><td class="markertitlecell"><input id="chkdrawing1259061" type="checkbox" onclick="C2MEngine.instance.chgDrawingDisp(1259061)" checked="true" />&nbsp;<a id="linkdrawing1259061" href="javascript:void(C2MEngine.instance.openDrawing(1259061));" title="" class="link_markername">Kelurahan/Desa Sanur</a></td></tr><tr class="markerrow"><td class="markericoncell" valign="top"><a href="javascript:void(C2MEngine.instance.openDrawing(1259072));" title=""><img src="./grd_polygon.png" style="border:0;width:16px;height:16px;" class="png" alt="" /></a></td><td class="markertitlecell"><input id="chkdrawing1259072" type="checkbox" onclick="C2MEngine.instance.chgDrawingDisp(1259072)" checked="true" />&nbsp;<a id="linkdrawing1259072" href="javascript:void(C2MEngine.instance.openDrawing(1259072));" title="" class="link_markername">Kelurahan/Desa Sanur Kauh</a></td></tr><tr class="markerrow"><td class="markericoncell" valign="top"><a href="javascript:void(C2MEngine.instance.openDrawing(1259077));" title=""><img src="./grd_polygon.png" style="border:0;width:16px;height:16px;" class="png" alt="" /></a></td><td class="markertitlecell"><input id="chkdrawing1259077" type="checkbox" onclick="C2MEngine.instance.chgDrawingDisp(1259077)" checked="true" />&nbsp;<a id="linkdrawing1259077" href="javascript:void(C2MEngine.instance.openDrawing(1259077));" title="" class="link_markername">Kelurahan/Desa Renon</a></td></tr><tr class="markerrow"><td class="markericoncell" valign="top"><a href="javascript:void(C2MEngine.instance.openDrawing(1259079));" title=""><img src="./grd_polygon.png" style="border:0;width:16px;height:16px;" class="png" alt="" /></a></td><td class="markertitlecell"><input id="chkdrawing1259079" type="checkbox" onclick="C2MEngine.instance.chgDrawingDisp(1259079)" checked="true" />&nbsp;<a id="linkdrawing1259079" href="javascript:void(C2MEngine.instance.openDrawing(1259079));" title="" class="link_markername">Kelurahan/Desa Sidakarya</a></td></tr><tr class="markerrow"><td class="markericoncell" valign="top"><a href="javascript:void(C2MEngine.instance.openDrawing(1259080));" title=""><img src="./grd_polygon.png" style="border:0;width:16px;height:16px;" class="png" alt="" /></a></td><td class="markertitlecell"><input id="chkdrawing1259080" type="checkbox" onclick="C2MEngine.instance.chgDrawingDisp(1259080)" checked="true" />&nbsp;<a id="linkdrawing1259080" href="javascript:void(C2MEngine.instance.openDrawing(1259080));" title="" class="link_markername">Kelurahan/Desa Panjer</a></td></tr><tr class="markerrow"><td class="markericoncell" valign="top"><a href="javascript:void(C2MEngine.instance.openDrawing(1259082));" title=""><img src="./grd_polygon.png" style="border:0;width:16px;height:16px;" class="png" alt="" /></a></td><td class="markertitlecell"><input id="chkdrawing1259082" type="checkbox" onclick="C2MEngine.instance.chgDrawingDisp(1259082)" checked="true" />&nbsp;<a id="linkdrawing1259082" href="javascript:void(C2MEngine.instance.openDrawing(1259082));" title="" class="link_markername">Kelurahan/Desa Sesetan</a></td></tr><tr class="markerrow"><td class="markericoncell" valign="top"><a href="javascript:void(C2MEngine.instance.openDrawing(1259084));" title=""><img src="./grd_polygon.png" style="border:0;width:16px;height:16px;" class="png" alt="" /></a></td><td class="markertitlecell"><input id="chkdrawing1259084" type="checkbox" onclick="C2MEngine.instance.chgDrawingDisp(1259084)" checked="true" />&nbsp;<a id="linkdrawing1259084" href="javascript:void(C2MEngine.instance.openDrawing(1259084));" title="" class="link_markername">Kelurahan/Desa Pedungan</a></td></tr><tr class="markerrow"><td class="markericoncell" valign="top"><a href="javascript:void(C2MEngine.instance.openDrawing(1259085));" title=""><img src="./grd_polygon.png" style="border:0;width:16px;height:16px;" class="png" alt="" /></a></td><td class="markertitlecell"><input id="chkdrawing1259085" type="checkbox" onclick="C2MEngine.instance.chgDrawingDisp(1259085)" checked="true" />&nbsp;<a id="linkdrawing1259085" href="javascript:void(C2MEngine.instance.openDrawing(1259085));" title="" class="link_markername">Kelurahan/Desa Pemogan</a></td></tr></table>
</div>
</div>
</div>
</div>
...
This map was built by Yunia Swandewi. <a href="http://www.click2map.com" title="Click to create your own map">Create a map</a> with Click2Map.
</div>
</div>
</div>
</div> 
...
var HTTP={};HTTP._factories=[function(){return new XMLHttpRequest();},function(){return new ActiveXObject("Msxml2.XMLHTTP");},function(){return new ActiveXObject("Microsoft.XMLHTTP");}];HTTP._factory=null;HTTP.newRequest=function()
...
var _iid=203202;var _isPreview=0;var _isWidget=0;var _mapElemId='map-content';var _widget=false;var _enableStat=0;var _generatorBaseUrl='.';var _generatorBaseImagesUrl='.';var _statEngineBaseUrl='';var _markersLoaderUrl='markers.js';var _markersInViewLoaderUrl='markers.js?v=1';var _markersInViewLoaderMarge=400;var _inViewLoading=0;var _searchUrl='';var _showHeader=1;var _showDescription=1;var _showFooter=1;var _showAds=0;var _adsenseCode='pub-6603054678213671';var _adHeight=100;var _adWidth=800;var _showSidebar=1;var _sidebarPos='right';var _sidebarWidth=300;var _showMarkerList=1;var _showDirections=0;var _showSearch=0;var _centerLat=-8.7028433891024;var _centerLng=115.24830837153;var _zoom=12;var _zoomOnOpenMarker=0;var _zoomControl='ddliLrg3D';var _openMarkerId=null;var _forceOpenMarker=false;var _enableHighlightMarkers=0;var _enableType=0;var _useMenuForMapType=true;var _enableScale=0;var _enableOverview=0;var _enableDragging=1;var _enableTraffic=0;var _trafficActive=false;var _enableDoubleclickZoom=1;var _enableContinuousZoom=1;var _enableInfowindow=1;var _enableMarkerDescription=0;var _enableDrawingsInList=1;var _enableMarkerZoomIn=0;var _enableToggle=1;var _defaultType='ddliMap';var _useTimerLoading=true;var _nMarkerPerTick=3;var _timerLoadingElapse=100;var _headerHeight=40;var _headerHeightWithDesc=32;var _footerHeight=25;var _sizerWidth=8;var _hideSidebarOnStartup=0;var _hideSideBarOnOpenMarker=0;var _showTabs=0;var _enableGotoAdress=0;var _localSearch=null;var _language="en";var _mapBorderWidth=1;var _mapMarginWidth=0;var _enableCustomStyle=1;var _mapStyleTabBorderColor='#aaa';var _enable_cluster=1;var _enable_pub_cluster=1;var _clustSize=8;var _clustNbNeeded=3;var _clustType=0;var _clustDynZoom=5;var _clustMaxZoom=15;var _clustLowZoom=1;var _toggleCompatible=true;
var _ieFamily=false;var _tile_layers=[];var _s_loading_app="Loading map...";var _s_loading="Loading...";var _s_progress_loading="Loading";var _s_dir_from="from";var _s_dir_to="to";var _s_dir_unknown="Unknown";var _s_dir_about="about";var _s_no_dir_found="<p>Directions cannot be found.<\/p><p>Suggestions:<br\/><li style='list-style:inside square;'>Please check addresses spelling<\/li><li style='list-style:inside square;'>Please make sure that the address contains at least a City name<\/li><li style='list-style:inside square;'>Try to add a zip code<\/li><\/p>";var _gmap_version='3.13';var _logo_anchor='lb';var _logo_x=0;var _logo_y=38;var _correctDrawingInfoWindowPos=true;var _saturation=null;
...
if(_enableDoubleclickZoom)this.gmap.enableDoubleClickZoom();else this.gmap.disableDoubleClickZoom();if(_enableDoubleclickZoom)this.gmap.enableScrollWheelZoom();else this.gmap.disableScrollWheelZoom();if(_enableContinuousZoom)this.gmap.enableContinuousZoom();else this.gmap.disableContinuousZoom();if(_enableInfowindow)this.gmap.enableInfoWindow();else this.gmap.disableInfoWindow();if(_tile_layers.length==0){if(_defaultType=='ddliMap'){this.gmap.setMapType(G_NORMAL_MAP);}else if(_defaultType=='ddliSatellite'){this.gmap.setMapType(G_SATELLITE_MAP);}else if(_defaultType=='ddliHybrid'){this.gmap.setMapType(G_HYBRID_MAP);}else if(_defaultType=='ddliTerrain'){this.gmap.setMapType(G_PHYSICAL_MAP);}else if(_defaultType=='ddliSatellite3D'){this.gmap.setMapType(G_SATELLITE_3D_MAP);}}
...
gmarker.__id=marker.id;gmarker.__iid=marker.iid;gmarker.__group_id=marker.group_id;gmarker.__tabs=marker.tabs;gmarker.__numberValue=marker.number_value;gmarker.__gId=this.gmarkers.length;gmarker.__order=marker.order;gmarker.__url=marker.url;gmarker.__url_link_new_window=marker.url_link_new_window;gmarker.__url_open_on_click=marker.url_open_on_click;GEvent.addListener(gmarker,"click",function(){self.openMarkerInfoWindow(gmarker,gmarker.__tabs,'m',null);if(_enableStat&&!_isPreview)C2MEngine.statAction(_iid,gmarker.__iid,3,0,null);});return gmarker;},createDrawing:function(drawing,show)
...
openMarkerLinkOnClick:function(url,newWindow,gmarker){if(_isPreview){this.previewOpenMarkerLinkOnClick(url,newWindow,gmarker);return true;}
if(url!==''){var wdw=window;if(newWindow){wdw.open(url,'_blank');}else{if(_isWidget&&window.parent){wdw=window.parent;if(window.location!=window.parent.location){}}
var openParent=true;if(openParent){wdw.location.href=url;}else{window.location.href=url;}}
return true;}},openMarkerInfoWindow:function(gmarker,tabs,from,gPoint)
{if(from=='l'&&_hideSideBarOnOpenMarker){C2MEngine.hideSidebar();this.gmap.checkResize();}
if((gmarker.__url_open_on_click||0)==1)
{if(from=='m'){this.openMarkerLinkOnClick(gmarker.__url,gmarker.__url_link_new_window,gmarker);return true;}else if(from=='l'){this.gmap.panTo(gmarker.getPoint());if(_enableHighlightMarkers)this.highlightLatLng(gmarker.getLatLng());return true;}}
...
{var htmlDrawing="<div class=\"drawing_infowindow\">";var drawing=null;if(typeof(position)==='undefined'&&gPoly.getBounds){position=gPoly.getBounds().getCenter();if(_correctDrawingInfoWindowPos){var refPoly=gPoly.polygon||gPoly.polyline;if(refPoly){var nbMax=10;var i=0;while(!google.maps.geometry.poly.containsLocation(position,refPoly)==false&&i<nbMax){var a=new GLatLngBounds(position,gPoly.getBounds().getNorthEast());var b=new GLatLngBounds(position,a.getCenter());position=b.getCenter();i++;}
if(!google.maps.geometry.poly.containsLocation(position,refPoly)){position=gPoly.getBounds().getCenter();}
i=0;while(!google.maps.geometry.poly.containsLocation(position,refPoly)&&i<nbMax){var a=new GLatLngBounds(gPoly.getBounds().getSouthWest(),position);var b=new GLatLngBounds(a.getCenter(),position);position=b.getCenter();i++;}}}}
for(var i=0;i<this.drawings.length;i++){if(gPoly.__id==this.drawings[i].id){drawing=this.drawings[i];break;}}
...
if(drawing.description){var description=new String(drawing.description);var reg=new RegExp("\\n","g");description=description.replace(reg,"<br \/>");if(description.length>0&&description!=='<br>'){innerHtml=innerHtml+"<div class=\"drawing_description\">"+description+"<\/div>";}}
...
if(!openByGroup){this.openDrawingInfoWindow(gPoly);}}},openMarker:function(id,lat,lng)
...
{var marker=this.findMarker(id);if(marker!=null){this.gmap.closeInfoWindow();var from=_s_dir_unknown;if(marker.title!='')from=marker.title;$('dir_from_addr').value='('+from+')';this.directions.from=marker;if(_showDirections){this.selectTab('directions_tab');}
this.directionsFind();}else{if(_inViewLoading){C2MEngine.mapLoadBarShow();var self=this;var request=HTTP.newRequest();request.onreadystatechange=function()
{if(request.readyState==4){if(request.status==200){if(request.getResponseHeader("Content-type")=="application/json"){var data=eval('('+request.responseText+')');var markers=data.markers;if(markers.length>0){var marker=markers[0];self.gmap.closeInfoWindow();var from=_s_dir_unknown;if(marker.title!='')from=marker.title;$('dir_from_addr').value='('+from+')';self.directions.from=marker;if(_showDirections){self.selectTab('directions_tab');}
self.directionsFind();}}}
...
{var marker=this.findMarker(id);if(marker!=null){this.gmap.closeInfoWindow();var to=_s_dir_unknown;if(marker.title!='')to=marker.title;$('dir_to_addr').value='('+to+')';this.directions.to=marker;if(_showDirections){this.selectTab('directions_tab');}
this.directionsFind();}else{if(_inViewLoading){C2MEngine.mapLoadBarShow();var self=this;var request=HTTP.newRequest();request.onreadystatechange=function()
{if(request.readyState==4){if(request.status==200){if(request.getResponseHeader("Content-type")=="application/json"){var data=eval('('+request.responseText+')');var markers=data.markers;if(markers.length>0){var marker=markers[0];self.gmap.closeInfoWindow();var to=_s_dir_unknown;if(marker.title!='')to=marker.title;$('dir_to_addr').value='('+to+')';self.directions.to=marker;if(_showDirections){self.selectTab('directions_tab');}
self.directionsFind();}}}
C2MEngine.mapLoadBarHide();}}
...
{if(this._highlightCircle){this._highlightCircle.setMap(null);this._highlightCircle=null;}
if(!latlng)return;this._highlightCircle=new google.maps.Marker({position:latlng,zIndex:-99,icon:{path:google.maps.SymbolPath.CIRCLE,fillOpacity:0.65,fillColor:'#ff0000',strokeOpacity:0.8,strokeColor:'#ff0000',strokeWeight:2.0,scale:20}});this._highlightCircle.setMap(this.gmap.map);},
...
<a href="http://www.click2map.com" title="Create a map with Click2Map" target="_blank"><img id="builtwithimg" src="https://d2njlksuqgkb9c.cloudfront.net/generator/images/built_with_click2map.png" style="border:0" width="101" height="22" alt="Built with Click2Map" /></a>
</div>
</body>
<!-- Build by Click2Map Generator v.2.5.2 (http://www.click2map.com) on Tue, 31 Mar 2020 11:02:34 GMT -->
</html>
